 ...
 *
 */
class Composer @JvmOverloads constructor(
    ...
    val node: Node?
        get() {
            ...
            if (parser.checkEvent(Event.ID.StreamEnd)) {
                ...
                val children = emptyList<NodeTuple>()
                val node: Node =
                    MappingNode(Tag.COMMENT, false, children, startMark, null, DumperOptions.FlowStyle.BLOCK)
