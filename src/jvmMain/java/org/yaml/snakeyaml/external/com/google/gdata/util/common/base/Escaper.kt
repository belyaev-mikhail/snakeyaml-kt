...
interface Escaper {
     ...
     *
     *  * [UnicodeEscaper] handles [UTF-16](http://en.wikipedia.org/wiki/UTF-16) correctly,
     ...
     * if `string` contains badly formed UTF-16 or cannot be
     ...
     * escaping it.
     */
    fun escape(out: Appendable?): Appendable
}