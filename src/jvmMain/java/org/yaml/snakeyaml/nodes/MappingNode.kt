 ...
 */
class MappingNode(
    tag: Tag, resolved: Boolean, value: MutableList<NodeTuple>, startMark: Mark?,
     ...
     */
    override var value: MutableList<NodeTuple> = value
    /**
    ...
    constructor(tag: Tag, value: MutableList<NodeTuple>, flowStyle: DumperOptions.FlowStyle?) : this(
        tag,
        true,
        value,
        null,
    ...
    ) : this(tag, resolved, value, startMark, endMark, DumperOptions.FlowStyle.Companion.fromBoolean(flowStyle)) {
    }
     ...
     */
    @Deprecated("")
    constructor(tag: Tag, value: MutableList<NodeTuple>, flowStyle: Boolean?) : this(
        tag,
        value,
        DumperOptions.FlowStyle.Companion.fromBoolean(flowStyle)
    ) {
    }
