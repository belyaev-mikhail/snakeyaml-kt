...
interface Scanner {
     ...
     * @return `true` if the next token is one of the given types.
     ...
     *
     * @return The token that will be returned on the next call to [.getToken]
     ...
     * (Every invocation of this method must happen after calling either [.checkToken]
     * or [.peekToken]
     *
     *
